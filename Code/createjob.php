...
?>
	<div id="login">
		<form action="addjob.php" method="post">
			...
			<input type="text" id="box" style="width: 65%"name="address" placeholder="Job Address" pattern="[1-9][0-9]{0,4} [A-Za-z- \.]+" required><br>
			<input type="text" id="box" style="width: 40%" name="zip" placeholder="Zip Code" pattern="[0-9]{5}"required><br><br>
